...
/// Reusable six-box OTP input.
///
/// Each box accepts one numeric digit, then the combined code is saved into
/// AuthController.otpController.text for verification.
...
class _OtpInputFieldState extends State<OtpInputField> {
  ...
  void _syncBoxesFromController() {
    final currentOtp = _authController.otpController.text;
    for (var index = 0; index < _otpLength; index++) {
      if (index < currentOtp.length) {
        _boxControllers[index].text = currentOtp[index];
      }
    }
  }
}
